...
import net.tutorgram.missslayqueenke.Model.Cart;
import net.tutorgram.missslayqueenke.Prevalent.Prevalent;
import net.tutorgram.missslayqueenke.R;
import net.tutorgram.missslayqueenke.ViewHolder.CartViewHolder;
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    if (shippingState.equals("shipped"))
                    {
                        ...
                        txtMsg1.setText("The order has been placed successfully.The Package is coming to you.");
