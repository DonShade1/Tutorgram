package net.tutorgram.missslayqueenke.Admin;
...
import net.tutorgram.missslayqueenke.Interface.ItemClickListner;
...
public class AdminCheckNewProductsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.admin_products_checklist);
